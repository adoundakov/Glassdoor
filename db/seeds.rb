...
Company.create!(name: 'Google',
                size: '10,001+',
                ceo: 'Sundar Pichai',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127434/logos/google_logo.png',
...
Company.create!(name: 'App Academy',
                size: '51-200',
                ceo: 'Ned Ruggeri',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/aa_logo_r3youa.png',
...
Company.create!(name: 'nVidia',
                size: '5,001-10,000',
                ceo: 'Jen-Hsun Huang',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/nvidia_logo_jilt5b.jpg',
...
Company.create!(name: 'Magic Leap',
                size: '201-500',
                ceo: 'Sam Miller',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/magic_leap_logo_qxibtj.png',
...
Company.create!(name: 'Bio-Rad Laboratories',
                ...
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127213/logos/biorad_logo_powvsg.jpg',
...
Company.create!(name: 'Zoox',
                size: '51-200',
                ceo: 'Tim Kentley-Kay',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/zoox_logo_rykdqh.png',
...
Company.create!(name: 'Six Flags',
                size: '10,001+',
                ceo: 'John M. Duffey',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/six_flags_logo_khjohv.jpg',
...
Company.create!(name: 'Wayfair',
                size: '1,001-5,000',
                ceo: 'Niraj Shah',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/wayfair_logo_gbylab.png',
...
Company.create!(name: 'EMC',
                size: '1,001-5,000',
                ceo: 'David Goulden',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/emc_logo_aaen2m.png',
...
Company.create!(name: 'Akamai',
                size: '10,001+',
                ceo: 'Jonathan Seelig',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127213/logos/akamai_logo_i2q2vn.png',
...
Company.create!(name: 'FiscalNote',
                size: '51-200',
                ceo: 'Gerald Yao',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/fiscal_note_logo_wisfy5.jpg',
...
Company.create!(name: 'GoodRx',
                size: '11-50',
                ceo: 'Scott Marlette',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/goodrx_logo_sccyrb.jpg',
...
Company.create!(name: 'Favor',
                size: '51-200',
                ceo: 'Ben Doherty',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/favor_logo_pjcgm7.png',
...
Company.create!(name: 'Expense Bot',
                size: '1-10',
                ceo: 'Ed Bucholz',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/expensebot_logo_dapitm.png',
...
Company.create!(name: 'Editas Medicine',
                size: '11-50',
                ceo: 'J. Keith Joung',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/editas_logo_ocxyy9.jpg',
...
Company.create!(name: 'Duo Security',
                size: '201-500',
                ceo: 'Jon Oberheide',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/duo_logo_w7x6sr.jpg',
...
Company.create!(name: 'DroneShield',
                size: '11-50',
                ceo: 'John Franklin',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/drone_shield_logo_hcik24.jpg',
...
Company.create!(name: 'Ducky Channel',
                size: '201-500',
                ceo: 'not found',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/ducky_logo_anzocl.png',
                cover_url: 'https://static1.squarespace.com/static/52f7e010e4b0b0787ce07b19/t/56afc85c2b8dded389a2b4e8/1454360673633/',
                location: 'Taipei, TW',
                company_url: 'www.duckychannel.com.tw',
...
Company.create!(name: 'CrowdTangle',
                ...
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127213/logos/crowd_tangle_logo_ootntb.png',
...
Company.create!(name: 'Facebook',
                size: '10,001+',
                ceo: 'Mark Zuckerberg',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/facebook_logo_hjkdjl.png',
...
Company.create!(name: 'Mopio',
                size: '1-10',
                ceo: 'Hakan Ensari',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/mopio_logo_pw72aw.png',
...
Company.create!(name: 'Tesla Motors',
                size: '51-200',
                ceo: 'Elon Musk',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/tesla_logo_jaufwq.png',
...
Company.create!(name: 'Dropbox',
                size: '1,001-5,000',
                ceo: 'Drew Houston',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/dropbox_logo_c9iqey.png',
...
Company.create!(name: 'SpaceX',
                size: '1,001-5,000',
                ceo: 'Elon Musk',
                logo_url: 'http://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/spacex_logo_kcdtse.png',
...
Company.create!(name: 'Glassdoor',
                size: '501-1,000',
                ceo: 'Robert Hohman',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/glassdoor_logo_vvm6ow.png',
...
Company.create!(name: 'Twitch',
                size: '201-500',
                ceo: 'Emmett Shear',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127216/logos/twitch_logo_qttgth.png',
...
Company.create!(name: 'Bungie',
                size: '501-1,000',
                ceo: 'Pete Parsons',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/bungie_logo_na2ftr.jpg',
...
Company.create!(name: 'CD Projekt Red',
                size: '201-500',
                ceo: 'Marcin Iwinski',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127214/logos/cdpr_logo_vcwrmg.png',
...
Company.create!(name: 'NZXT',
                size: '51-200',
                ceo: 'Johnny Hou',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/nzxt_logo_jbblct.jpg',
...
Company.create!(name: 'Mionix',
                size: '11-50',
                ceo: 'Carl Silbersky',
                logo_url: 'https://res.cloudinary.com/adoundakov/image/upload/v1485127215/logos/mionix_logo_k89zhh.png',
